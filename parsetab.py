...
_lr_productions = [
  ...
  ('exp -> exp SUB exp','exp',3,'p_exp_sub','Parser.py',23),
  ('exp -> exp MUL exp','exp',3,'p_exp_mul','Parser.py',27),
  ('exp -> exp DIV exp','exp',3,'p_exp_div','Parser.py',31),
  ('exp -> INTEGER','exp',1,'p_exp_integer','Parser.py',35),
]
